...
public class RandomFactory {
	private static Logger logger = Logger.getLogger(RandomFactory.class.getName());
	...
	public static void setRandom(Random random) {
		...
		// TODO ZAMO using Robot classloader inject seed also for all instances
		// being created by robots
	}
	...
	/**
	 * Logs a warning that the deterministic random feature is not supported by
	 * the JVM.
	 */
