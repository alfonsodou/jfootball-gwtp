package org.javahispano.jfootball.client.application.widget.gwtcodemirror.client;
...
public class GWTCodeMirror extends Composite implements TakesValue<String>, HasValueChangeHandlers<String>, HasEnabled {
    ...
    private native JavaScriptObject setup(GWTCodeMirror myCodeMirror, String id, JavaScriptObject initialOptions)/*-{
                ...
                extraKeys: {
                    "Ctrl-Space": function (editor) {
                        $wnd.CodeMirror.showHint(editor, function (editor, callback) {
                            ...
                            $entry(myCodeMirror.@org.javahispano.jfootball.client.application.widget.gwtcodemirror.client.GWTCodeMirror::getCompletions(Ljava/lang/String;IIILcom/google/gwt/core/client/JavaScriptObject;Lcom/google/gwt/core/client/JavaScriptObject;)(editor.getValue(), cursor.line, cursor.ch, index, result, callback));
                        }, {async: true});
                    }
                }
            }
        ...
        theCM.on("change", function () {
            $entry(myCodeMirror.@org.javahispano.jfootball.client.application.widget.gwtcodemirror.client.GWTCodeMirror::handleChange()());
        });
        return theCM;
